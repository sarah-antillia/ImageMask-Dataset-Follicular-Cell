...
class ImageMaskDatasetGenerator:
  ...
  def generate(self):
    ...
    if num_images != num_masks:
       raise Exception("Unmatched image_files and mask_files")
    index = 100000
    for i in range(num_images):
      ...
      output_image_filepath = os.path.join(self.output_images_dir, filename )
      output_mask_filepath  = os.path.join(self.output_masks_dir,  filename )
...
if __name__ == "__main__":
  try:
    output_dir = "./Follicular-Cell-master"
    ...
    augmentation     = False
    generator = ImageMaskDatasetGenerator(train_images_dir, train_masks_dir, 
                                          train_output_dir,
                                          rename = True,
                                          resize = True,
    ...
    augmentation     = False
    generator = ImageMaskDatasetGenerator(test_images_dir, test_masks_dir, 
                                          test_output_dir,
                                          rename = True,
                                          resize = True,
                                          augmentation=augmentation, 
